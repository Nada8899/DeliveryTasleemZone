...
namespace TasleemDelivery.Repository.UnitOfWork
{
    public class UnitOfWork:IUnitOfWork
    {
        ...
        public IGenericRepository<ClientChat, int> ClientChatRepository => new GenericRepository<ClientChat, int>(_context);
        public IGenericRepository<DeliveryChat, int> DeliveryChatRepository => new GenericRepository<DeliveryChat, int>(_context);
