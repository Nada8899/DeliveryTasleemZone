        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverView = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    YearExperinces = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Languge", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Languge_Client_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Client",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Languge_Delivery_DeliveryId",
                        column: x => x.DeliveryId,
                        principalTable: "Delivery",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Review_Delivery_DeliveryId",
                        column: x => x.DeliveryId,
                        principalTable: "Delivery",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Languge_ClientId",
                table: "Languge",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Languge_DeliveryId",
                table: "Languge",
                column: "DeliveryId");

            migrationBuilder.CreateIndex(
                name: "IX_Proposal_DeliveryId",
                table: "Proposal",
                column: "DeliveryId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Delivery_EducationLevel_EducationLevelID",
                table: "Delivery",
                column: "EducationLevelID",
